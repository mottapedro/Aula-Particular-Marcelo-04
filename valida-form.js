...
form.addEventListener('submit', (evento) => {
    evento.preventDefault();//serve para previnor o comportamento
...
function checkInputs() {
    ...
    if (password === '') {
        ...
        erroValidation(username, 'Esse campo deve conter no minimo 9 carcteres')
    } else {
    ...
    if (passwordtwoValue === '') {
        ...
        erroValidation(password, 'A senha dever ser igual');
    } else {
